...
try {
  ...
  try {
    ...
    await waitFor(app, 'location.hash.includes("category=55555555-5555-4555-8555-555555555555") && document.querySelector(".category-tabs button.active")?.textContent?.includes("数码")', '系统返回恢复类别筛选');
    await app.evaluate('document.querySelector(".asset-card-link")?.click()');
    ...
    await waitFor(app, 'location.hash.includes("category=55555555-5555-4555-8555-555555555555") && document.querySelector(".category-tabs button.active")?.textContent?.includes("数码")', '详情返回恢复类别筛选');
    await app.evaluate('location.hash = "#/"');
    ...
    await app.evaluate('history.back()');
    await waitFor(app, 'location.hash.includes("/categories/55555555-5555-4555-8555-555555555555") && document.body.innerText.includes("数码账本")', '系统返回分类账本');
    await app.evaluate('document.querySelector(".asset-card-link")?.click()');
