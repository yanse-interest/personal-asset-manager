...
const assets: Asset[] = ids.map((id, index) => ({ id, name: `资产${index}`, purchaseCostCents: (index + 1) * 10_000, purchaseDate: '2026-09-13', costMode: 'day', usageCount: 0, expiryDate: null, note: null, categoryId: index === 0 ? category.id : null, lifecycleStatus: statuses[index]!, endedDate: index === 0 ? null : '2026-09-13', iconId: null, createdAt: timestamp, updatedAt: timestamp }));
